...
const thumbnails = [
  ...
  { src: "/site-assets/collection/unishare-vol.29-press36.png", height: 150 },
  { src: "/site-assets/collection/unishare-vol.29-press37.png", height: 150 },
  { src: "/site-assets/collection/unishare-vol.29-press38.png", height: 150 },
  { src: "/site-assets/collection/unishare-vol.29-press39.png", height: 150 },
];

const backnumberImage = "/site-assets/collection/frame-1.png";
  ...
  return (
    <div className="collection-page">
      ...
      <main className="collection-main">
        ...
        <section className="collection-backnumber" data-node-id="110:179">
          <div className="collection-backnumber__inner">
            <div className="collection-backnumber__card">
              <img src={backnumberImage} alt="" />
            </div>
          </div>
        </section>
